...
@Client.on_message(filters.group & filters.text & ~filters.edited & filters.incoming & filters.group(AUTH_GROUPS) if AUTH_GROUPS else filters.text & filters.group & filters.incoming)
