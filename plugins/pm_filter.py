...
@Client.on_message(filters.group & filters.private & filters.text & ~filters.edited & filters.incoming & filters.user(AUTH_USERS) if AUTH_USERS else filters.text & filters.private & filters.incoming & filters.user(AUTH_GROUPS) if AUTH_GROUPS else filters.text & filters.private & filters.incoming)
